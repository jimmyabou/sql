...
SELECT vendor.vendor_id, vendor.vendor_name, COUNT(vendor_booth_assignments.vendor_id) AS assignments
...
GROUP by customer.customer_last_name, customer.customer_last_name
...
SELECT customer_id, SUM(quantity * cost_to_customer_per_qty) as total 
FROM customer_purchases
